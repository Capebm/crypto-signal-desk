...
export default function PriceChart({ symbol, action, interval, onIntervalChange, entry, stop, target }: Props) {
  ...
  useEffect(() => {
    ...
    void getCandles(symbol, interval, 200).then((rows) => {
      if (!active) return
  ...
  }, [symbol, action, interval, entry, stop, target])

  return (
    <div className="chart-host">
      <div className="chart-toolbar">
        <div className="chart-legend"><span>EMA 20</span><span>EMA 50</span><span>Volume</span></div>
